...
@section('content')
<div class="column is-9" id="appAnemiaDef">
  <section class="hero is-info welcome is-small">
      <div class="hero-body">
          <div class="container">
              <h1 class="title">
                Deficiencia de Hierro y Recuperado Menores 3 Años
              </h1>
              <h2 class="subtitle">
                  Indicadores
              </h2>
...
<!-- 3D library -->
<script src="{{ asset('node_modules/highcharts/highcharts-3d.js') }}"></script>
<script src="{{ asset('node_modules/highcharts/modules/cylinder.js') }}"></script>

<script src="{{ url('/node_modules/axios/dist/axios.min.js') }}"></script>
<script src="{{ url('/node_modules/vue/dist/vue.min.js') }}"></script>
<script src="{{ asset('/public/js/indicadores/appAnemiaDef.js') }}"></script>
