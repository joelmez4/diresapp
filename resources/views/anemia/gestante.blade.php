...
<div class="column is-9" id="appAnemiaGestantes">
            ...
            <div class="card" v-if="person != null">
              <div class="card-content">
                ...
                <div class="content">
                  ...
                  <br>
                  <time datetime="2019-01-30">Fuente: INEI</time>
                </div>
              </div>
            </div>
            <div class="card" v-else>
              <div class="card-content">
                <div class="notification is-danger">
                  <strong>No esta registrado.</strong>
                </div>
              </div>
            </div>
          </section>
...
<script src="{{ asset('/public/js/anemia/appAnemiaGestantes.js') }}"></script>
